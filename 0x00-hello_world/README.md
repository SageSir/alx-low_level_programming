This project is the first C project 0x00-hello_world of the ALX School curriculum, and covers the very basics of compilation and C.
...
File 6-size.c is a C program that prints the size of various data types on the computer it is compiled and run on.
